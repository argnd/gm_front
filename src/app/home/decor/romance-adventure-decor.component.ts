...
@Component({
  selector: 'app-decor-romance-adventure',
  templateUrl: './romance-adventure-decor.component.html',
  styleUrl: './romance-adventure-decor.component.scss',
  host: {
    '[class]': '"decor-" + slot()',
...
export class RomanceAdventureDecorComponent {
  ...
  protected readonly romanceLeads = computed(() => this.state() === 'romance-2-adventure-1');
  protected readonly adventureLeads = computed(() => this.state() === 'adventure-2-romance-1');
  ...
  protected readonly romanceTier = computed(() => tierOf(ambianceValue(this.ambiance(), 'romance')));

  protected readonly adventureTier = computed(() =>
    tierOf(ambianceValue(this.ambiance(), 'adventure')),
  );
